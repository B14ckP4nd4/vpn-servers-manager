<div>
    ...
    <div class="modal-body">
        ...
        @endif
        <input type="hidden" wire:model="selectedInventory">
        <div class="mb-3">
    ...
    <div class="modal-footer">
        <a wire:click="cancelUpdate()" href="#" class="btn btn-link link-secondary" data-bs-dismiss="modal">
            Cancel
        </a>
        <a wire:click="update()" class="btn btn-primary ms-auto">
