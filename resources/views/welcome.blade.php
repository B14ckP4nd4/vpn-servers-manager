<x-guest-layout>
    <div class="container-tight py-4">
        <div class="empty">
            ...
            <p class="empty-title">There is nothing here for you !</p>
            <p class="empty-subtitle text-muted">
                Sorry about it but there isn't nothing here for present to you ! lets try this
            </p>
            <div class="empty-action">
                <a href="https://www.google.com/search?q=what+am+i+doing+here" class="btn btn-primary">
